...
import { Wrench, MapPin, Clock, Shield, Users, Zap } from "lucide-react"
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-slate-900">ECU Remap Pro</h1>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-slate-900 mb-4">Why Choose ECU Remap Pro?</h3>
      ...
      <footer className="bg-white border-t py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-slate-900">ECU Remap Pro</span>
              </div>
          ...
          <div className="border-t mt-8 pt-8 text-center text-slate-600">
            <p>&copy; 2024 ECU Remap Pro. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
